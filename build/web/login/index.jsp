...
<html lang="pt-br">
    ...
    <head>
        ...
        <script src="${pageContext.request.contextPath}/public/plugins/sweetalert2/sweetalert2.all.min.js" defer></script>
        <!-- jQuery -->
        ...
        <!-- Select2 -->
        <script src="${pageContext.request.contextPath}/public/plugins/select2/js/select2.full.min.js" defer></script>
        ...
        <!-- PESQUISAR CEP -->
        <!--script src="${pageContext.request.contextPath}/public/assets/js/searchCep.js" defer></script-->
        <!-- TODOS PAISES SELECT NACIONALIDADE -->
        <script src="${pageContext.request.contextPath}/public/assets/js/getCountry.js" defer></script>

        <!-- AdminLTE for demo purposes -->
        <!--script src="${pageContext.request.contextPath}/public/dist/js/demo.js" defer></script-->
        <script src="${pageContext.request.contextPath}/public/assets/js/default.js" defer></script>
    ...
    <body cz-shortcut-listen="true">
        <nav class="navbar navbar-expand navbar-white navbar-light justify-content-between border-bottom">
            <!-- Left navbar links -->
            <a href="./login.jsp">
                <img src="${pageContext.request.contextPath}/public/img/icon-civa-footer-darkblue.svg" alt="logo civa" width="180px" class="ml-5">
            </a>
            ...
            <div class="login-box">
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <form action="/civa2/auth" method="POST">
                            <div class="form-group input-group mb-3 col-xl-12 ">
                                ...
                                <select id="perfil" name="perfil" class="select2 select2-hidden-accessible"
                                    ...
                                    <option value="" selected disabled>Selecionar acesso </option>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="email" id="civa" name="civa" style="display: none;" class="form-control" placeholder="civa">
                ...
                <div class="card-body row justify-content-around">
                    <div class="col-5 text-center d-flex align-items-center justify-content-center">
                        <div class="">
                            ...
                            <p class="lead m-5 text-left">Somos uma carteira digital de vacinaï¿½ï¿½o de iniciativa da OMS, trabalhamos para garantir que a saï¿½de e seguranï¿½a da populaï¿½ï¿½o.</p>
                        </div>
                    </div>
                    <div class="col-5">
                        <div class="card-header text-center h1">
