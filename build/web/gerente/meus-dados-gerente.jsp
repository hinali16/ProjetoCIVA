                                        ...
                                        <div class="row">
                                            <div class="form-group col-xl-6">
                                                ...
                                                <select id="genero" name="genero" class="select2 select2-hidden-accessible"
                                                    ...
                                                    <option selected value=""  disabled>Selecionar G&ecirc;nero
                                                    </option>
                                            ...
                                            <div class="form-group col-xl-6">
                                                ...
                                                <input type="date" id="date-birth" name="date-birth"
                                                    class="form-control" value="1995-04-12">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-xl-12">
                                                ...
                                                <input type="text" class="form-control" id="codigopostal"
                                                    name="codigopostal" value="65789-784" maxlength="9"
                                                    >
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-xl-6">
                                                ...
                                                <input type="text" class="form-control" id="estado" name="estado"
                                                    value="Rio de Janeiro" maxlength="9">
                                            </div>
