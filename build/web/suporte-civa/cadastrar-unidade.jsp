                  ...
                  <div class="card-body">
                      <div class="row">
                          <div class="form-group col-xl-6">
                              ...
                              <input type="text" id="name-unidade" name="name-unidade" class="form-control"
                                  placeholder="Hospital e maternidade santos" >
                          </div>
                          <div class="form-group col-xl-6">
                              <label for="documento-registro">Documento de registro</label>
                              <input type="text" id="documento-registro" name="documento-registro" class="form-control"
                                  placeholder="24.456456/5" >
                          </div>
                      </div>
                      ...
                      <div class="row">
                          <div class="form-group col-xl-6">
                              ...
                              <select  class="select2 select2-hidden-accessible" style="width: 100%;"
                                  tabindex="-1" aria-hidden="true" id="natureza" name="natureza">
                          ...
                          <div class="form-group col-xl-6">
                              ...
                              <select  class="select2 select2-hidden-accessible" style="width: 100%;"
                                  tabindex="-1" aria-hidden="true" id="tipo-estabelecimento"
                      ...
                      <div class="row">
                          ...
                          <div class="form-group col-xl-12">
                              ...
                              <input type="text" class="form-control" id="codigopostal"
                                  name="codigopostal" placeholder="12345-789" maxlength="9"
                                  value="" >
                          </div>
                      </div>
                      ...
                      <div class="row">
                          ...
                          <div class="form-group col-xl-6">
                              ...
                              <input type="number" class="form-control" id="numero"
                                  name="numero" placeholder="123" maxlength="9"
                                  value="" >
                          </div>
                      </div>
                      ...
                      <div class="row">
                          <div class="form-group col-xl-6">
                              ...
                              <input type="text" id="complemento" name="complemento" class="form-control"
                                  placeholder="Apto 1107 bloco 2" >
                          </div>

                          <div class="form-group col-xl-6">
                              <label for="bairro">Bairro</label>
                              <input type="text" class="form-control" id="bairro"
                                  name="bairro"  maxlength="9"
                                  placeholder="Tijuca" >
                          </div>
                      ...
                      <div class="row">
                          <div class="form-group col-xl-6">
                              ...
                              <input type="tel" class="form-control" id="contato1" name="contato1"
                                  placeholder="2199887755" maxlength="9" value="" >
                          </div>
