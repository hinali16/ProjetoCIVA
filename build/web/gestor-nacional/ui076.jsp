...
<div class="row">
  <div class="form-group col-xl-6">
      ...
      <input type="email" class="form-control"  id="name" value="Maria" disabled>
  </div>
  <div class="form-group col-xl-6">
      <label for="exampleFormControlInput1">Sobrenome</label>
      <input type="email" class="form-control" id="surname" value="Almeida" disabled >
  </div>
</div>
<div class="row">
  <div class="form-group col-xl-6">
    <label for="exampleFormControlInput1">C&oacute;digo CIVA</label>
    <input type="text" class="form-control" id="code-civa" value="BRA5513456789" disabled>
</div>
  <div class="form-group col-xl-6">
      <label for="exampleFormControlInput1">Identidade</label>
      <input type="text" class="form-control" id="identity" value="101.154.807-02" disabled>
  </div>
</div>
<div class="row">
  <div class="form-group col-xl-6">
    <label for="exampleFormControlInput1">Data de nascimento</label>
    <input type="date" class="form-control" id="date-birth" placeholder="00/00/0000" disabled>
  </div>
  <div class="form-group col-xl-6">
    <label for="exampleFormControlInput1">ID Pa&iacute;s</label>
    <input type="text" class="form-control" id="idpais" value="5512345" disabled>
</div>
<!-- <div class="form-group col-12">
  ...
  <select disabled class="select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true">
    ...
    <option selected value="2">Brasil</option>
...
<div class="row">
  <div class="form-group col-6">
      ...
      <input type="text" class="form-control" id="postal-code" value="22758-006" disabled>
  </div>
</div>
<div class="row">
<div class="form-group col-12">
  <label for="exampleFormControlSelect1">Logradouro</label>
    ...
    <input type="email" class="form-control" id="logrd-name" value="Av Rio Branco" disabled>
</div>
</div>
...
<div class="row">
  ...
  <div class="form-group col-xl-6">
      ...
      <input type="email" class="form-control" id="email" value="maria1612_almeida@gmail.com" disabled>
  </div>
</div>
</div>
</div>
