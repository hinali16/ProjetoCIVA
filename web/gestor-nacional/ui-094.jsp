...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="./index-gestor.jsp">Voltar</a></li>
                                    ...
                                    <div class="p-2">
                                        <div class="row">
                                            <div class="form-group col-xl-6">
                                                ...
                                                <input type="name" class="form-control" value="Hospital Pan" id="name">
                                            </div>
                                            <div class="form-group col-xl-6">
                                                <label for="exampleFormControlInput1">ID unidade</label>
                                                <input type="text" class="form-control" id="identity" value="12345678" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
        ...
        <option>S&atilde;o Cristovão</option>
        <option>Barra</option>
        <option>Botafogo</option>
          ...
          <option>Privada</option>
                                        ...
                                        <div class="form-group col-xl-6">
                                            ...
                                            <input type="text" class="form-control" id="estab-name" value="Hospital">
                                        </div>
                                        <div class="d-flex justify-content-between align-items-center mx-3 mb-2">
                                            <div id="toggle-user">
                                                <div class="custom-control custom-switch">
                                                    ...
                                                    <label class="custom-control-label" for="customSwitch2"></label><b class="text-primary">ATIVADO</b>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
