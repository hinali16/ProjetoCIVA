                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="form-group col-xl-12">
                        ...
                        <input type="text" id="identity" name="identity" class="form-control"  value="USA1223456789" readonly>
                      </div>
                    </div>
                    <hr>
                    <div class="row">
                      <div class="form-group col-xl-6">
                        ...
                        <input type="text" id="name" name="name" class="form-control" value="Bryan" readonly>
                      </div>
                      <div class="form-group col-xl-6">
                        <label for="surname">Sobrenome</label>
                        <input type="text" id="surname" name="surname"  class="form-control" value="Adams" readonly>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="form-group col-xl-6">
                        ...
                        <input type="date" id="date-birth" name="date-birth" class="form-control" value="1945-05-17" readonly>
                      </div>
                      <div class="form-group col-xl-6">
                        <label for="passaporte">Passaporte</label>
                        <input type="text" id="passaporte" name="passaporte" class="form-control" value="8697894894" readonly>
                      </div>
                    ...
                    <div class="row">
                      <div class="form-group col-12">
                        ...
                        <input type="text" id="pais" name="pais" class="form-control" value="EUA" readonly>
                      </div>
                    </div>
                  </div>
                </form>
