            ...
            <div class="modal-content card-primary card-outline">
                <div class="card-body">
                    <div class="col d-flex flex-column justify-content-center align-items-center">
                        <img src="${pageContext.request.contextPath}/public/img/confirmacao.svg" alt="Dados eliminados"><br>

                        <p class="text-center">Conta deletada</p>
                        <p>Seus dados foram exclu&iacute;dos com sucesso.</p>
                        <div class="">

                            <a href="${pageContext.request.contextPath}/login/index.jsp"><button type="button" class="btn btn-primary">Concluir</button></a>
                        </div>
                    </div>
                </div>
            </div>
