        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/supervisor/index.jsp">Voltar</a></li>
...
<!-- Select2 -->
<script src="${pageContext.request.contextPath}/public/plugins/select2/js/select2.full.min.js"></script>
<!-- AdminLTE App -->
